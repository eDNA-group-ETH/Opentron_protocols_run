...
def run(protocol: protocol_api.ProtocolContext):
    ...
    # Elution column
    elute_wells = [reagents[x] for x in elute_cols]
        ...
        for col in cols:
            ...
            for n in range(0,3): 
                ...
                pipette_left.dispense(190,
                                      mag_plate.wells_by_name()[col].bottom(z=25),
                                      rate = 0.5)
   ...
   # protocol.delay(seconds=pause_dry)
    ...
    # add elution buffer
    bead_remaining, elute_wells = add_buffer(pipette_left,
                                            elute_wells,
                                            mag_plate,
                                            cols,
                                            elute_vol,
