...
def run(protocol: protocol_api.ProtocolContext):
    ...
    # reagents
    reagents = protocol.load_labware('thermoscientificnunc_96_wellplate_2000ul',
                                     11, 'reagents')
    ...
    pipette_20.flow_rate.aspirate = 50
    ...
    for p in pcr_plates:
        ...
        pipette_300.distribute(mm_vol,
                                 ...
                                 [pcr_obj[p][c].bottom(z=2) for c in sample_cols],
                                 blow_out=True,
